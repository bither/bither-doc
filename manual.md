...
彻底解决安全问题有两点：1、对私钥要绝对的“冷”存储，不要暴露在任何与网络连接的设备上；2、加强内部管理，我们可以说，只要随机数是可靠的，冷钱包对于黑客威胁来说，应该是绝对安全的，毕竟物理上隔绝了黑客入侵的可能。”
...
对很多刚接触比特币以及想使用比太的用户朋友们而言，比太的使用方法无疑是最关键的问题。比太的使用其实并不复杂，只要掌握正确的使用方式，就能妥善地保管好我们的比特币。那么接下来请跟我一起学习如何使用比太来玩转比特币~

##### 一 热钱包：

功能预览

安装成功后，在有网络和断网的情况下会有不同的界面，冰火两重天的酸爽哦~
...
*温馨提示*：要牢牢记住你的HD账户密语和二维码~ 而且建议使用Xrandom创建HD账户(对勾要选中)，最大限度地保证比特币安全。如下图所示：

![Xrandom](images/Screenshot_2015-12-02-13-35-05x_net_bither.png)

当你卸载了比太或者需要重新找回HD账户时，你只需要在”高级选项“中的”导入私钥“选项中选择方式来恢复或者找回你的HD账户。

![findUser](images/Screenshot_2015-12-02-17-53-06_net.bither.png)

创建成功的HD账户保存在你的手机里面了，保存好HD种子，它可以用来恢复HD账户的。也许很多人不明白什么是HD账户，你也可以把它理解为私钥的集群。

生成私钥：利用智能手机的多种感应设备，比太首创的“极随机“，帮你获取”真“随机数。公私钥的搭配让FBI和量子计算机都拿你的比特币没办法（最多50个）。
...
冷钱包也是需要创建HD账户以及私钥的，操作方法其实和热钱包是一样的~ 冷HD账户也就是私钥的集群，私钥就是来进行解密和为交易签名的最重要的资源。
...
比太钱包独有冷热钱包模式，让普通用户只需手机就能使用，既安全，又易用。同时，比太钱包首创“极随机”XRandom，利用了智能手机上的多种感应设备，采集环境噪声，帮用户轻松获取“真”随机数。比太模式的冷热、极随机这些技术，国内外的钱包都没有。另外，比太钱包支持全平台，智能手机支持iOS和安卓，桌面版是Java的，因此支持Windows，Mac OS，Linux。
...
冷热钱包指的是，用户在日常手机上运行比太热钱包。生成热钱包私钥，存放小额比特币，满足日常支付需求。用户还可以准备一个备用手机，淘汰下来的旧手机，或者新购买的廉价安卓，100多块钱的都行。在离线断网的情况下，运行比太冷钱包。生成一定数量的冷钱包地址，用来存放大额比特币。因为离线断网，不用担心黑客盗取。而且手机的用户体验很好，大家可以很方便的进行日常操作。热钱包可以监控冷钱包。也就是说，日常手机：小额、热钱包，监控冷钱包。备用手机：大额、离线。
...
欢迎加入我们比太钱包官方QQ群 : 219098359  群内有我们的热心开发者等待您的加入!
